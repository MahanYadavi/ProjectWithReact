...
const resources = {
  ...
  fa: {
    ...
    header: {
      ...
      projectsData: {
        p1: { title: 'اجرای Ladder&Tray در واحد های ASP,LF,EF به متراژ 15KM', location: 'ابهر، شهرک صنعتی نورین', description: 'طرف قرارداد: مجتمع ذوب آهن البرز ناب آرش' },
        p2: { title: 'اجرای واحد (SVC,MAIN SUB Station) 33KV', location: 'ابهر,شهرک صنعتی نورین', description: 'طرف قرارداد:مجتمع ذوب آهن البرز ناب آرش' },
        ...
        p6: { title: 'اجرای Ladder & Tray خط 33kv در کانال تاسیسات به طول 8', location: 'ابهر,شهرک صنعتی نورین', description: 'طرف قرارداد:مجتمع ذوب آهن البرز ناب آرش' },
        ...
        p12: { title: 'اجرای پست 20/63 کیلوولت', location: 'نطنز,شهرک صنعتی شجاع آباد', description: 'طرف قرارداد:شرکت فولاد و ذوب آهن نطنز' },
        ...
        p32: { title: 'سرویس تعمیر و راه اندازی 60 دستگاه ترانسی (5.5کیلوولت)خط نورد RM3', location: 'نطنز,شهرک صنعتی شجاع آباد', description: 'طرف قرارداد:شرکت فولاد و ذوب آهن نطنز' },
