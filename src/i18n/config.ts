  ...
  fa: {
    translation: {
      ...
      intro: {
        ...
        description: 'شرکت ما با بیش از ۱۵ سال تجربه در اجرای پروژه‌های EPC، برق صنعتی، خطوط انتقال گاز و تأسیسات گندله‌سازی، توانسته همکاری با مجموعه‌های بزرگ صنعتی و معدنی کشور را در کارنامه خود ثبت کند.',
        stat1: 'سال سابقه',
        stat2: 'پروژه موفق',
        stat3: 'مهندس متخصص'
      },
      ...
      clients: {
        title: 'مشتریان و شرکای ارزشمند ما',
      },
      projects: {
      ...
      projectsPage: {
        ...
        categories: {
          all: 'همه',
          substations: 'پست‌های برق',
          transmission: 'خطوط انتقال',
          pelletizing: 'گندله‌سازی',
          epc: 'EPC صنعتی',
      ...
      projectsData: {
        ...
        p8: { title: 'نصب تابلو های MV&LV', location: 'ابهر,شهرک صنعتی نورین​', description: 'کارهای برقی و مکانیکی برای توسعه خط تولید گندله‌سازی.' },
        ...
        p11: { title: 'اجرای پست 230 به 33کیلوولت', location: 'کرمان، ایران', description: '' },
        p12: { title: 'نصب کابل‌های فشارقوی در نیروگاه رامین', location: 'اهواز، ایران', description: 'اجرای کابل‌کشی و اتصالات فشارقوی با استانداردهای بین‌المaللی.' },
        p13: { title: 'خط انتقال ۴۰۰ کیلوولت – تبریز به زنجان', location: 'آذربایجان شرقی و زنجان، ایران', description: 'ساخت و نگهداری خط انتقال دو مداره برای افزایش ظرفیت شبکه.' },
        p14: { title: 'اتوماسیون کارخانه فولاد خراسان', location: 'مشهد، ایران', description: 'پیاده‌سازی سیستم کنترل مرکزی برای خطوط تولید فولاد.' },
        p15: { title: 'پروژه EPC نیروگاه سیکل ترکیبی پرند', location: 'تهران، ایران', description: 'قرارداد EPC شامل نصب، راه‌اندازی و تست تجهیزات نیروگاهی.' },
        p16: { title: 'مشاوره شبکه برق هوشمند در دبی', location: 'دبی، امارات', description: 'تحلیل و بهبود عملکرد شبکه برق با استفاده از تکنولوژی‌های نوین.' },
        p17: { title: 'تحویل پست ۱۳۲/۲۰ کیلوولت سیار', location: 'اصفهان، ایران', description: 'استقرار سریع پست سیار برای پروژه‌های اضطراری و پشتیبانی شبکه.' },
        p18: { title: 'نگهداری خطوط انتقال هوایی ۲۳۰ کیلوولت', location: 'شیراز، ایران', description: 'بازرسی و تعمیرات دوره‌ای خطوط انتقال هوایی برای اطمینان از پایداری شبکه.' },
        p19: { title: 'توسعه کارخانه گندله‌سازی میدکو', location: 'یزد، ایران', description: 'اجرای پروژه‌های برق و اتوماسیون برای افزایش ظرفیت تولید گندله.' },
        p20: { title: 'ارتقاء سیستم اتوماسیون پتروشیمی بندر امام', location: 'خوزستان، ایران', description: 'مدرن‌سازی سیستم‌های DCS، PLC و SCADA برای افزایش بهره‌وری.' },
        p21: { title: 'پروژه EPC مجتمع فولاد سبا', location: 'اصفهان، ایران', description: 'اجرای پروژه EPC شامل نصب، راه‌اندازی و تست تجهیزات تولید فولاد.' },
        p22: { title: 'نصب سینی و نردبان کابل در نیروگاه شهید رجایی', location: 'قزوین، ایران', description: 'اجرای کامل سیستم کابل‌کشی و زیرساخت‌های برقی نیروگاهی.' },
        p23: { title: 'خط انتقال ۲۳۰ کیلوولت – اهواز به دزفول', location: 'خوزستان، ایران', description: 'احداث و نگهداری خط انتقال دو مداره برای تقویت شبکه منطقه‌ای.' },
        p24: { title: 'اتوماسیون کارخانه فولاد اکسین', location: 'اهواز، ایران', description: 'ارتقاء سیستم‌های کنترلی و اتوماسیون خطوط تولید فولاد.' },
        p25: { title: 'پروژه EPC نیروگاه حرارتی شازند', location: 'مرکزی، ایران', description: 'قرارداد EPC شامل نصب، راه‌اندازی و تست تجهیزات نیروگاهی.' },
        p26: { title: 'مشاوره شبکه برق هوشمند در ریاض', location: 'ریاض، عربستان سعودی', description: 'تحلیل شبکه و طراحی راهکارهای هوشمند برای افزایش پایداری و بهره‌وری.' },
        p27: { title: 'تحویل پست سیار ۲۰/۶۳ کیلوولت', location: 'کرمان، ایران', description: 'استقرار سریع پست‌های سیار برای پشتیبانی پروژه‌ها و اضطراری.' },
        p28: { title: 'نگهداری خطوط انتقال هوایی ۴۰۰ کیلوولت – اصفهان', location: 'اصفهان، ایران', description: 'بازرسی و تعمیرات دوره‌ای خطوط انتقال حیاتی برای حفظ امنیت شبکه.' },
        p29: { title: 'توسعه کارخانه گندله‌سازی گل‌گهر ۲', location: 'کرمان، ایران', description: 'اجرای بخش‌های برق و مکانیک پروژه توسعه خطوط تولید گندله.' },
        p30: { title: 'ارتقاء اتوماسیون پتروشیمی شیراز', location: 'شیراز، ایران', description: 'مدرن‌سازی سیستم‌های DCS و ESD واحدهای پتروشیمی.' },
        p31: { title: 'پروژه EPC مجتمع فولاد خراسان', location: 'مشهد، ایران', description: 'اجرای EPC شامل نصب، راه‌اندازی و تست تجهیزات خطوط تولید فولاد.' },
        p32: { title: 'نصب کابل و سینی در نیروگاه سیکل ترکیبی پرند', location: 'تهران، ایران', description: 'اجرای پروژه کامل کابل‌کشی و زیرساخت‌های برقی نیروگاه.' },
        p33: { title: 'خط انتقال ۴۰۰ کیلوولت – تهران به قزوین', location: 'تهران و قزوین، ایران', description: 'ساخت و نگهداری خط انتقال هوایی دو مداره برای تقویت شبکه.' },
        p34: { title: 'اتوماسیون کارخانه فولاد میانه', location: 'آذربایجان شرقی، ایران', description: 'پیاده‌سازی سیستم کنترل مرکزی و اتوماسیون خطوط تولید فولاد.' },
