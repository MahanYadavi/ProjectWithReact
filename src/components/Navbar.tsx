        ...
        {isOpen && (
          ...
          >
            <div className="px-4 py-4 space-y-3">
              ...
              <div className="border-t border-gray-200 dark:border-navy-800 pt-4">
                <p className="px-4 text-xs font-semibold text-gray-500 dark:text-gray-400 mb-2 text-center">Language</p>
                  ...
                  {languages.map((lang) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded text-sm font-medium text-center transition-all ${
                        i18n.language === lang.code
                          ? 'bg-gold-600 text-white'
                          : 'text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-navy-800'
                      }`}
                    >
                      {lang.name}
                    </button>
