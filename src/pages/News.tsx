...
const News: React.FC = () => {
  ...
  const { featured, topStories, latestNews } = getNewsItems(t);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <Link to={`/news/${featured.slug}`} className="block h-full">
                <div className="relative h-72 md:h-96 overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    ...
                    <p className="mt-3 text-white/80">{featured.excerpt}</p>
                  </div>
                </div>
                <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-5">
                  ...
                  <span className="inline-flex items-center gap-2 text-sm font-semibold text-gold-600 dark:text-gold-400 group-hover:text-gold-500">
                    {t('newsPage.readMore')}
            ...
            <div className="space-y-6">
              {topStories.map((story) => (
                ...
                >
                  <Link to={`/news/${story.slug}`} className="flex gap-4">
                    <img
                      src={story.image}
                      alt={story.title}
